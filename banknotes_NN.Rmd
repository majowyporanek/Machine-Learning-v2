...
model = tnn.Sequential(
    ...
    tnn.ReLU(),                          
    tnn.Linear(in_features=16, out_features=8),
    tnn.ReLU(),                          
    tnn.Linear(in_features=8, out_features=1),
    tnn.Sigmoid()                         
)
```
...
#Changed to Adam optimizer for better convergence
...
disp = ConfusionMatrixDisplay(confusion_matrix=cm, display_labels=["Real (0)", "Counterfeit (1)"])

fig, ax = plt.subplots(figsize=(6, 6))
disp.plot(cmap=plt.cm.Blues, ax=ax)
plt.title("Confusion Matrix for Banknote Counterfeit Detection")
plt.show()
```
